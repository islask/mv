sap.ui.define([
	...
	"use strict";
	return Controller.extend("qldh.ZHR_F_MV_CLAIM.controller.ClaimForm", {
		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf qldh.ZHR_F_MV_CLAIM.view.ClaimForm
		 */
		onInit: function () {
		...
		onSelectRow: function (oEvent) {
			this.getView().byId("btnUpdate").enabled(true);
			this.getView().byId("btnRemove").enabled(true);
		},
		/**
		...
		/**
		 *@memberOf qldh.ZHR_F_MV_CLAIM.controller.ClaimForm
		 */
		onBtnAdd: function (oEvent) {
			var oView = this.getView();
			var oDialog = oView.byId("dialogMileage");
			if (!oDialog) {
				oDialog = sap.ui.xmlfragment(oView.getId(), "qldh.ZHR_F_MV_CLAIM.view.fragments.MileageRecord", this);
		 ...
		 *@memberOf qldh.ZHR_F_MV_CLAIM.controller.ClaimForm
		 */
		onBtnUpdate: function (oEvent) {
			//This code was generated by the layout editor.
		},
		/**
		 *@memberOf qldh.ZHR_F_MV_CLAIM.controller.ClaimForm
		 */
		onBtnRemove: function (oEvent) {
			//This code was generated by the layout editor.
		}
	});
});